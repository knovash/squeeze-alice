# Squeeze‑Alice
## Это интеграция мультирум колонок Lyrion Media Server в Умный Дом Яндекс
...
- ⏭️ forward 20s
- ⏹ stop all
- что играет - колонка LMS ответит название и громкость
- 🏠 переключи сюда - музыка прекличиться на эту колонку, другие выключаться
- переключить пульт на следующую колонку LMS
