...
public class ContextMqtt {
    ...
    public static ContextMqtt contextCreate(HttpExchange httpExchange) {
//      METHOD
...
//        log.info("QUERY MAP: " + queryMap);
        ...
        ContextMqtt context = new ContextMqtt();
        context.body = body;
...
//        log.info("CONTEXT TO JSON START");
    ...
    public static ContextMqtt fromJson(String json) {
//        log.info("CONTEXT FROM JSON START");
//        log.info("JSON: " + json);
        try {
            ObjectMapper mapper = new ObjectMapper();
            return mapper.readValue(json, ContextMqtt.class);
        } catch (JsonProcessingException e) {
            e.printStackTrace();
            return null;
        }
