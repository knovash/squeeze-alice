...
//
//@Log4j2
//public class ProviderQuery_bak {
//
...
//            log.info("NAME: " + SmartHome.getDeviceById(device_id).customData.lmsName);
//            log.info("ROOM: " + SmartHome.getDeviceById(device_id).room);
...
//        Player player = lmsPlayers.getPlayerByName(SmartHome.getDeviceById(device_id).customData.lmsName);
//        Integer volume = 0;
//        Boolean power = false;
//        if (player != null) {
